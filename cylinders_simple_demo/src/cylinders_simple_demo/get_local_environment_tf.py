...
from cylinders_simple_demo.grid_utils_tf import batch_center_res_shape_to_origin_point, round_to_res, swap_xy, \
    batch_align_to_grid_tf
...
def get_local_env_and_origin_point(center_point,
    ...
    batch_y_indices_in_full_env_frame = indices['y'] + _expand(local_to_full_offset[:, 0])
