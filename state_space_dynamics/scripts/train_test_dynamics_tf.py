...
def train_main(args, seed: int):
    train_test_dynamics_tf.train_main(dataset_dirs=args.dataset_dirs,
...
def eval_main(args, seed: int):
    train_test_dynamics_tf.eval_main(args.dataset_dirs, args.checkpoint, args.mode, args.batch_size)


def viz_main(args, seed: int):
    train_test_dynamics_tf.viz_main(**vars(args))
