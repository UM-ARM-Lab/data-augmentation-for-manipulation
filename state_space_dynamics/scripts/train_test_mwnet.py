...
def main():
    ...
    fine_tune_parser.add_argument('--batch-size', type=int, default=512)
    ...
    viz_parser.add_argument('--weight-above', type=float)
    viz_parser.add_argument('--weight-below', type=float)
