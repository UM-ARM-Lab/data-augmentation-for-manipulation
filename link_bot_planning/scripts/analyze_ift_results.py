...
def metrics_main(args):
    ...
    figspecs = [
        ...
        FigSpec(fig=LinePlot(analysis_params, xlabel="Num Steps", ylabel='Solved', ylim=[0,1]),
                reductions={num_steps.__name__:  [None, 'cumsum', 'sum'],
        ...
        FigSpec(fig=LinePlot(analysis_params, xlabel="Iterations", ylabel='Task Error'),
                ...
                axis_names=['y']),
        FigSpec(fig=LinePlot(analysis_params, xlabel="Iterations", ylabel='Percent Success', ylim=[0,1]),
                reductions={success.__name__: [None, None, 'mean']},
                axis_names=['y']),
        FigSpec(fig=LinePlot(analysis_params, xlabel="Num Steps", ylabel='Percent Success', ylim=[0,1]),
                reductions={num_steps.__name__: [None, 'cumsum', 'sum'],
        ...
        FigSpec(fig=LinePlot(analysis_params, xlabel="Num Steps", ylabel='Percent Success (rolling)', ylim=[0,1]),
                reductions={num_steps.__name__: [None, 'cumsum', 'sum'],
