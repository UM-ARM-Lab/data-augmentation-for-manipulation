...
def metrics_main(args):
    ...
    figspecs = [
        ...
        FigSpec(fig=LinePlot(analysis_params, xlabel="Num Steps", ylabel='Solved', ylim=ylim),
                reductions={num_steps.__name__:  [None, 'cumsum', 'sum'],
        ...
        FigSpec(fig=LinePlot(analysis_params, xlabel="Iterations", ylabel='Task Error'),
                ...
                axis_names=['y']),
        FigSpec(fig=LinePlot(analysis_params, xlabel="Iterations", ylabel='Percent Success', ylim=ylim),
                reductions={success.__name__: [None, None, 'mean']},
                axis_names=['y']),
        FigSpec(fig=LinePlot(analysis_params, xlabel="Num Steps", ylabel='Percent Success', ylim=ylim),
                reductions={num_steps.__name__: [None, 'cumsum', 'sum'],
                            success.__name__:   [None, None, 'mean']}),
        FigSpec(fig=LinePlot(analysis_params, xlabel="Num Steps", ylabel='Percent Success (rolling)', ylim=ylim),
                reductions={num_steps.__name__: [None, 'cumsum', 'sum'],
