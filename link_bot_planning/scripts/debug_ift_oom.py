...
@ros_init.with_ros("debug_ift_oom")
def main():
    ...
    d = pathlib.Path('/media/shared/cl_trials/val_car_new1/May_26_18-02-36_c5cea66458/best_checkpoint/')

    models = []
    for i in range(100):
        m = classifier_utils.load_generic_model(d, scenario=scenario)
        models.append(m)
